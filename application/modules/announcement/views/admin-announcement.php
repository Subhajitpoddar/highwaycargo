              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Announcement Dashboard</h1>
                  ...
                  <div class="row">
                        <div class="col-md-12">
                        <form action="<?php echo base_url();?>admin-announcements-data" method="post" enctype="multipart/form-data">     
                            <div class="form-group">
                                <label>Announcement Description:</label>
                                <textarea rows="15" cols="20" name="announcementdes" class="form-control"></textarea>
                                 <script>
