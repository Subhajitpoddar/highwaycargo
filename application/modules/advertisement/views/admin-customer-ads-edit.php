              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Customer Advertisement Dashboard</h1>                        
                    </div>
                    <!-- Content Row -->                  
                  <div class="row">
                    <div class="col-md-12">
                        ...
                        ?>
                    <form action="<?php echo base_url();?>admin-customer-ads-update" method="post" enctype="multipart/form-data">
                        <p><input type="hidden" name="id" value="<?php echo $customer_edit_rs->id;?>"></p>
                            <div class="form-group">
                                <label>Advertisement Title:</label>
                                <input type="text" name="advertisementtitle" class="form-control" value="<?php echo $customer_edit_rs->customer_ads_name;?>">                                
                            </div> 
                             <div class="form-group">
                                <label>Advertisement Upload:</label>
                                 <td><img src="<?php echo base_url();?>assets/backend/img/customer-ads-img/<?php echo $customer_edit_rs->customer_ads_file;?>" style="height:100px;" class="text-center"></td>
