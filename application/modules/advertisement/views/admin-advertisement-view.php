              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Vendor Advertisement List Dashboard</h1>                       
  ...
  <table class="table table-striped">
    ...
    <tbody>
      ...
      <tr>
        ...
        <td><img src="<?php echo base_url();?>assets/backend/img/advertisement-img/<?php echo $advertisement_rs_view->advertisement_image;?>" style="height:100px;" class="text-center"></td>             
       <td><a href="<?php echo base_url();?>admin-advertisement-edit/<?php echo $advertisement_rs_view->id;?>" class="btn btn-primary">Edit</a></td>      
      </tr>
      <?php
      }
