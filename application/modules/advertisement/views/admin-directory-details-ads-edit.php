              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Side Manu Directory Edit Dashboard</h1> 
                        <a href="<?php echo base_url();?>admin-directory-view" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> View List</a>                       
                    </div>
                    <!-- Content Row -->                  
                  <div class="row">
                    <div class="col-md-12">
                        <?php foreach($directory_details_edit as $directory_edit_rs) { ?>
                    <form action="<?php echo base_url();?>admin-directory_details_update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Directory Upload:</label>
                                 <td><img src="<?php echo base_url();?>assets/backend/img/directory-details-ads/<?php echo $directory_edit_rs->image;?>" style="height:100px;" class="text-center"></td>
