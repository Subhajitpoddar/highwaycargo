              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Service advertisement Edit Dashboard</h1>
                   ...
                   <?php foreach($advertisement_edit as $advertisement_edit_rs)
                            {
                                ?>
                        <form action="<?php echo base_url();?>admin-service-advertisement-upd" method="post" enctype="multipart/form-data">
                    <p><input type="hidden" name="id" value="<?php echo $advertisement_edit_rs->id;?>"></p>
                            <div class="form-group">
                             ...
                             <td><img src="<?php echo base_url();?>assets/backend/img/service-advertisement/<?php echo $advertisement_edit_rs->advertisement_image;?>" style="height:100px;" class="text-center"></td><br> 
