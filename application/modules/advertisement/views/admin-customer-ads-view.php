...
<body id="page-top">
              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Customer Advertisement List Dashboard</h1>                       
  ...
  <table class="table table-striped">
    ...
    <tbody>
        <?php
        foreach($customer_rs as $customer_rs_view){

        ?>
      <tr>
        <td><?php echo $customer_rs_view->customer_ads_name;?></td>
        <td><img src="<?php echo base_url();?>assets/backend/img/customer-ads-img/<?php echo $customer_rs_view->customer_ads_file;?>" style="height:100px;" class="text-center"></td>             
       <td><a href="<?php echo base_url();?>admin-customer-ads-edit/<?php echo $customer_rs_view->id;?>" class="btn btn-primary">Edit</a></td>      
      </tr>
      <?php
      }
