            ...
            <div id="content">
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                  ...
                  <div class="row">
                    <div class="col-md-12">
                    <form action="<?php echo base_url();?>admin-customer-advertisements-data" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Advertisement Title:</label>
                                <input type="text" name="advertisementtitle" class="form-control">                                
                            </div> 
                             <div class="form-group">
                            ...
                            <span class="text-danger">Note:-*width 400 pixels and height 533 pixels  and Maximum 100 kb File uplaod  </span>  <br>                                        
