              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Top  Manu Directory Edit  Dashboard</h1>  
                         <a href="<?php echo base_url();?>admin-directory-top-update" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> View List</a>                        
                    </div>
                    <!-- Content Row -->                  
                  <div class="row">
                    <div class="col-md-12">
                        <?php foreach ($directory_edit as $directory_edit_rs) { ?>
                            
                    <form action="<?php echo base_url();?>admin-directory-top-update" method="post" enctype="multipart/form-data">
                         <p><input type="hidden" name="id" value="<?php echo $directory_edit_rs->id;?>"></p>
                            <div class="form-group">
                                <label>Directory Top Ads Title:</label>
                                <input type="text" name="directorytitle" class="form-control" value="<?php echo $directory_edit_rs->title?>">                                
                            </div> 
                             <div class="form-group">
                                <label>Directory Upload:</label>
                                  <td><img src="<?php echo base_url();?>assets/backend/img/directory-top-ads/<?php echo $directory_edit_rs->image;?>" style="height:100px;" class="text-center"></td>   
                                <input type="file" name="directoryfile" class="form-control"> <br>
