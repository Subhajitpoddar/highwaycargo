              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                  ...
                  <div class="row">
                    ...
                    <form action="<?php echo base_url();?>admin-directory-update" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                <label>Directory Upload:</label>
                                 <td><img src="<?php echo base_url();?>assets/backend/img/directory-image/<?php echo $directory_edit_rs->image;?>" style="height:100px;" class="text-center"></td>
