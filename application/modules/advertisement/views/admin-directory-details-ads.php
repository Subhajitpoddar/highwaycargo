              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Top Directory Details Ads Dashboard</h1>  
                         <a href="<?php echo base_url();?>admin-directory-details-view" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm"> View List</a>                        
                    </div>
                    <!-- Content Row -->                  
                  <div class="row">
                    <div class="col-md-12">
                    <form action="<?php echo base_url();?>admin-directory-details-data" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Directory Details Ads Title:</label>
                                <input type="text" name="directorytitle" class="form-control">                                
                            </div> 
                             <div class="form-group">
                                <label>Directory Details Upload:</label>
