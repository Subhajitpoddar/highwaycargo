            ...
            <div id="content">
              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <form action="<?php echo base_url();?>admin-blog-db" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Blog Title:</label>
                                <input type="text" name="eventstil" class="form-control">                                
                            </div>                            
                            <div class="form-group">
                                <label>Blog Description:</label>
                                <textarea name="eventsdes" class="form-control"></textarea> 
                                 <script>
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="eventsshortdes" class="form-control"></textarea> 
                                <script>
