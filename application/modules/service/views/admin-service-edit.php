                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                           ...
                           {
                            ?>
                        <form action="<?php echo base_url();?>admin-serviceupd" method="post" enctype="multipart/form-data"> 
                            <td><input type="hidden" name="id" value="<?php echo $huy->id;?>"></td>
                            <div class="form-group">
                                <label>Service Title:</label>
                                <input type="text" name="servicetil" class="form-control" value="<?php echo $huy->svname;?>"> 
                            </div>
                            <div class="form-group">
                                <label>Service SEO Title:</label>
                                <input type="text" name="seotil" value="<?php echo $huy->seotitle;?>" class="form-control">
                            </div>                            
                            <div class="form-group">
                                <label>Service Description:</label>
                                <textarea name="servicedes" class="form-control" rows="15" cols="20"><?php echo $huy->svdescrb;?></textarea>
                                <script>
                            ...
                            <div class="form-group">
                                ...
                                <p class="text-danger">*Note :- Maximum 120 characters are allowed.</p>
                                <textarea name="serviceshortdes" class="form-control" rows="15" cols="20"><?php echo $huy->svshortdes;?></textarea>
                                <script>
                            ...
                            <input type="file" name="svfile" class="form-control"> <br>
