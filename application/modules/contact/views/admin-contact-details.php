            ...
            <div id="content">
              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <form action="<?php echo base_url();?>admin-contact-detailsdb" method="post" enctype="multipart/form-data"> 

                            <div class="form-group">
                                <label>Contact Details Title:</label>
                                <input type="text" name="contacttil" class="form-control">
                            ...
                            <div class="form-group">
                             ...
                             <div class="form-group">
                                ...
                                <textarea name="contactnumber" class="form-control"></textarea> 
                                <script>
                             ...
                             <div class="form-group">
                                ...
                                <textarea name="contactemail" class="form-control"></textarea> 
                                <script>
