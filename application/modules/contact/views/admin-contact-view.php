...
<body id="page-top">
              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Contact Details View </h1>                       
                    </div>
                    <!-- Content Row -->                  
                    <div class="row">
                        <div class="col-md-12">           
  <table class="table table-striped">
    ...
    <tbody>
        <?php
        foreach($contact_view as $huy){

        ?>
      <tr>
        <td><?php echo $huy->contacttitle;?></td>       
        <td><?php echo $huy->contactnum;?></td>
        <td><?php echo $huy->contactemail;?></td>
        <td><?php echo $huy->contactadres;?></td>               
      <td><a href="<?php echo base_url();?>admin-contactedit/<?php echo $huy->id;?>" class="btn btn-primary">Edit</a></td>
      </tr>
      <?php
      }
