        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Disclaimer Terms View </h1>     
            ...
            <div class="row">
                <div class="col-md-12">           
                  <table class="table table-striped">
                    <thead>
                      <tr>
                        <th>Disclaimer Terms Title</th>       
                        <th>Disclaimer Terms Description</th>                  
                        <th>Edit</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    foreach($disclaimer_view as $huy){
                        ?>
                        <tr>
                            <td><?php echo $huy->disclaimer_name;?></td>       
                            <td><?php echo $huy->disclaimer_details;?></td>                     
                            <td><a href="<?php echo base_url();?>admin-disclaimer-edit/<?php echo $huy->id;?>" class="btn btn-primary">Edit</a></td>
                        </tr>
                        <?php
                    }
                    ?>
