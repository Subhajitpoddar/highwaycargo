        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                ...
                <a href="<?php echo base_url();?>admin-policy-view" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">View list</a>
            </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <?php
                    foreach($policy_edit as $policy_edit_rs){
                        ?>
                        <form action="<?php echo base_url();?>admin-policy-upd" method="post" enctype="multipart/form-data">
                            <input type="hidden" name="id" value="<?php echo $policy_edit_rs->id;?>"> 
                            <div class="form-group">
                                <label>Privacy Policy Title:</label>
                                <input type="text" name="policyttil" class="form-control" value="<?php echo $policy_edit_rs->policy_name;?>">                                
                            </div>                    
                            <div class="form-group">
                                <label>Privacy Policy Description:</label>
                                <textarea name="policydescription" class="form-control"><?php echo $policy_edit_rs->policy_description;?></textarea> 
                                <script>
                                    CKEDITOR.replace("policydescription");
                                </script>                                
                            </div>                                                                        
