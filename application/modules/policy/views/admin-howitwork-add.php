              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin How it Works Add</h1>
                        <a href="<?php echo base_url();?>admin-policy-view" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">View list</a>
                    </div>
                    <!-- Content Row -->                  
                    <div class="row">
                        <div class="col-md-12">
                        <form action="<?php echo base_url();?>admin-howitwork-db" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>How it Works Title:</label>
                                <input type="text" name="howitworktil" class="form-control">                 
                            </div>                    
                            <div class="form-group">
                                <label>How it Works Description:</label>
                                <textarea name="howitworkdestails" class="form-control"></textarea> 
                                <script>
