        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">How it Works View </h1>     
            ...
            <div class="row">
                <div class="col-md-12">           
                  <table class="table table-striped">
                    <thead>
                      <tr>
                        <th>How it Works Title</th>       
                        <th>How it Works Description</th>                  
                        <th>Edit</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    foreach($howitwork_view as $huy){
                        ?>
                        <tr>
                            <td><?php echo $huy->howitwork_title;?></td>       
                            <td><?php echo $huy->howitwork_details;?></td>                     
                            <td><a href="<?php echo base_url();?>admin-howitwork-edit/<?php echo $huy->id;?>" class="btn btn-primary">Edit</a></td>
                        </tr>
                        <?php
                    }
                    ?>
