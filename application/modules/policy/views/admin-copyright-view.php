        ...
        <div id="content">
          ...
          <div class="container-fluid">
            ...
            <div class="d-sm-flex align-items-center justify-content-between mb-4">
                <h1 class="h3 mb-0 text-gray-800">Copyright Policy View </h1>     
            ...
            <div class="row">
                <div class="col-md-12">           
                  <table class="table table-striped">
                    <thead>
                      <tr>
                        <th>Copyright Policy Title</th>       
                        <th>Copyright Policy Description</th>                  
                        <th>Edit</th>
                    </tr>
                </thead>
                <tbody>
                    <?php
                    foreach($copyright_view as $huy){
                        ?>
                        <tr>
                            <td><?php echo $huy->copyright_title;?></td>       
                            <td><?php echo $huy->copyright_details;?></td>                     
                            <td><a href="<?php echo base_url();?>admin-copyright-edit/<?php echo $huy->id;?>" class="btn btn-primary">Edit</a></td>
                        </tr>
                        <?php
                    }
                    ?>
