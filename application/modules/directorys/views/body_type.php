...
<?php } ?>             
    ...
    <?php
    foreach($body_type_filter as $body_type_filter_rs){
        $vendor_id=$body_type_filter_rs->vendor_login_id;
        ?>  
        <?php
                $this->db->where("id='$vendor_id'");
                 $register_vendor=$this->db->get('vendor_registers_db');
                 $register=$register_vendor->result();
                 foreach($register as $register_rs){ 
                  $images=$register_rs->profile_picture;       
        ?>         
        <div class="row" id="directory-details">
            <div class="col-md-5">
               <?php if($images):?>
                <p>
                    <a href="<?php echo base_url();?>directory-details/<?php echo $register_rs->id;?>"><img src="<?php echo base_url();?>assets/backend/img/profile_image/<?php echo $register_rs->profile_picture;?>" alt="profile-image" class="img-responsive" data-retina="true"></a>
                </p>
                 <?php else:?> 
                       <p>
                   <a href="<?php echo base_url();?>directory-details/<?php echo $register_rs->id;?>"><img src="<?php echo base_url();?>assets/frontend/img/demo-profile.jpg" alt="profile-image" class="img-responsive" data-retina="true"></a>
                </p>
            <?php endif;?>
            </div>
            <div class="col-md-7">
                <div class="row">
                    <div class="col-md-9">
               <span class="company_title"><b><?php echo $register_rs->company_name;?></b></span><br>
               <span class="vendor"><i class="icon-user" id="icon"></i><?php echo $register_rs->first_name;?> <?php echo $register_rs->last_name;?></span><br>
                <span class="vendor"><i class="icon-home" id="icon"></i><b>Home Location:</b> <?php echo $register_rs->city;?> : <?php echo $register_rs->street;?></span><br>
                <span class="vendor"><b><i class="icon-location-7" id="icon"></i>destination location:</b></span><br>                
                <?php echo $register_rs->delivery_state;?><br>
                <a href="<?php echo base_url();?>directory-details/<?php echo $register_rs->id;?>" class="ls-l button_intro mt-3">View Details</a>
