...
<?php } ?>            
    ...
    <?php
    foreach($quick_search as $quick_search_view){
        $images=$quick_search_view->profile_picture;
        ?>           
        <div class="row" id="directory-details">
            <div class="col-md-5">
                 <?php if($images):?>
                <p>
                    <a href="<?php echo base_url();?>directory-details/<?php echo $quick_search_view->id;?>"><img src="<?php echo base_url();?>assets/backend/img/profile_image/<?php echo $quick_search_view->profile_picture;?>" alt="profile-image" class="img-responsive" data-retina="true"></a>
                </p>
                 <?php else:?> 
                       <p>
                   <a href="<?php echo base_url();?>directory-details/<?php echo $quick_search_view->id;?>"><img src="<?php echo base_url();?>assets/frontend/img/demo-profile.jpg" alt="profile-image" class="img-responsive" data-retina="true"></a>
                </p>
            <?php endif;?>
            </div>
            <div class="col-md-7">
               <div class="row">
                    <div class="col-md-9">
               <span class="company_title"><b><?php echo $quick_search_view->company_name;?></b></span><br>
               <span class="vendor"><i class="icon-user" id="icon"></i><?php echo $quick_search_view->first_name;?> <?php echo $quick_search_view->last_name;?></span><br>
                <span class="vendor"><i class="icon-home" id="icon"></i><b>Home Location:</b> <?php echo $quick_search_view->city;?> : <?php echo $quick_search_view->street;?></span><br>
                <span class="vendor"><b><i class="icon-location-7" id="icon"></i>destination location:</b></span><br>                
                <?php echo $quick_search_view->delivery_state;?><br>
                <a href="<?php echo base_url();?>directory-details/<?php echo $quick_search_view->id;?>" class="btn_1">View Details</a>
