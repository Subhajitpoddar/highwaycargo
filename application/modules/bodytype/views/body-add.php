              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Body Type Add</h1>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                        <form action="<?php echo base_url();?>admin-body-type-db" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Body Type Title:</label>
                                <input type="text" name="bodytitle" class="form-control">                                
                            </div>                                    
                            <div class="form-group">
                                <label>Body Type Image:</label><br>
