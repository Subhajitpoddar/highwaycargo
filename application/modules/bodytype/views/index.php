        ...
        <div class="container margin_60">
            <div class="row">
                <div class="col-md-9">
                    ...
                    ?>
                    <div class="post">
                        <a href="<?php echo base_url();?>blog-details/<?php echo $blog_rs_view->id;?>"><img src="<?php echo base_url();?>assets/frontend/img/blog-3.jpg" alt="blog-image" class="img-responsive border"></a>                       
