              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Mission Dashboard</h1>
                        <a href="<?php echo base_url();?>admin-missions-view" class="d-none d-sm-inline-block btn btn-sm btn-primary shadow-sm">View List</a>
                    </div>
                    <!-- Content Row -->                  
                  <div class="row">
                        <div class="col-md-12">
                        <form action="<?php echo base_url();?>admin-missions-data" method="post" enctype="multipart/form-data">   
                         <div class="form-group">
                                <label>Mission Title:</label>
                                <textarea rows="15" cols="20" type="text" name="mission_title" class="form-control"></textarea>    <script>
                                    CKEDITOR.replace("mission_title");
                                </script>                             
                            </div>     
                            <div class="form-group">
                                <label>Mission Description:</label>
                                <textarea rows="15" cols="20" name="mission_des" class="form-control"></textarea>
                                 <script>
