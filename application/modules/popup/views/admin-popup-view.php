...
<body id="page-top">
              ...
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Admin Pop Up View Dashboard</h1>                      
  ...
  <table class="table table-striped">
    ...
    <tbody>
        <?php
        foreach($pop_up as $pop_up_view){

        ?>
      <tr>
        <td><?php echo $pop_up_view->pop_up_title;?></td>
        <td><?php echo $pop_up_view->pop_up_description;?></td>                    
       <td><img src="<?php echo base_url();?>assets/backend/img/pop-up-image/<?php echo $pop_up_view->pop_up_image;?>" style="height:100px;" class="text-center"></td>   
        <td><a href="<?php echo base_url();?>admin-pop-up-edit/<?php echo $pop_up_view->id;?>" class="btn btn-primary">Edit</a></td>
      </tr>
      <?php
      }
