            ...
            <div id="content">
              <?php $this->load->view('common/backend/include/topbar');?>
                ...
                <div class="container-fluid">
                  ...
                  <div class="row">
                        <div class="col-md-12">
                        <form action="<?php echo base_url();?>admin-popup-data" method="post" enctype="multipart/form-data">
                            <div class="form-group">
                                <label>Pop-up Title:</label>
                                <input type="text" name="popup_til" class="form-control">                                
                            </div>                            
                            <div class="form-group">
                                <label>Pop-up Description:</label>
                                <textarea rows="8" cols="7" name="popup_des" class="form-control"></textarea>
                                 <script>
