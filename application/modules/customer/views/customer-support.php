...
<main>
  <div class="container margin_60">
   ...
   <div class="row" id="borders">    
     <div class="col-md-12">     
      <form  action="<?php echo base_url();?>customer-support-data" method="POST" enctype="multipart/form-data">                   
                        <div class="row">
                            <?php $un_id=$this->session->userdata('user_id');?>
                           <p><input type="hidden" name="user_ids" value="<?php echo $un_id;?>"></p>
                           <div class="col-md-3">
